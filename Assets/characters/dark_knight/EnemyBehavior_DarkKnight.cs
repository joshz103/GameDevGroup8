...
public class EnemyBehavior_DarkKnight : MonoBehaviour
{
    public EnemyHP hp;
    ...
    public EnemyAttackHitboxDarkKnight attackHitbox;
    ...
    public void MoveBackwards()
    {
        ...
        GetComponent<Rigidbody>().velocity = this.transform.forward * 25f;
    }
